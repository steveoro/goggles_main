...
- **0.10.32** [Steve A.] added Goggle Cup browse page for team managers and admins; year/team selectors, cup title buttons, and Turbo Stream stored ranking with base timings; request/view/Cucumber coverage; re-sync w/ base engine v0.10.1
...
- **0.9.25** [Steve A.] fix for laps/relay_laps components in show results; last_season_id caching by SolidCache instead of cookies; re-sync w/ base engine; bundle updates
- **0.9.23** [Steve A.] bundle updates; docker container hardening; fixes for SMTP service setup
- **0.9.20** [Steve A.] BestSwimmerCurrentVsPreviousResult v5; re-sync w/ base engine; bundle updateupdate; DB vers. 2.09.11, rel. 0.9.20
