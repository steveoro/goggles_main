...
RSpec.describe Solver::Swimmer, type: :strategy do
  context 'before #solve!,' do
    it_behaves_like('Solver strategy, bindings, finder & creator, before #solve!', 'Swimmer', described_class)
  end
  #-- -------------------------------------------------------------------------
  #++
  ...
  context 'with EMPTY #req data,' do
    ...
    it_behaves_like('Solver strategy, NO bindings, UNSOLVABLE req, after #solve!', 'Swimmer')
  end
