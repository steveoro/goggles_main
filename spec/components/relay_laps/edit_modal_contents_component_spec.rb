...
RSpec.describe RelayLaps::EditModalContentsComponent, type: :component do
  ...
  context 'when specifying a valid parent relay result with existing laps' do
    ...
    let(:rendered_modal) { subject }

    it 'includes the edit modal content body' do
      expect(rendered_modal.at('#lap-edit-modal-body')).to be_present
    end
