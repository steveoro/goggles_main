...
module Solver
  ...
  class MeetingRelaySwimmer < BaseStrategy
    ...
    def finder_strategy
      ...
      # Priority #1
      return GogglesDb::MeetingRelaySwimmer.find_by_id(id) if id.to_i.positive?
    ...
    def required_bindings
      @bindings.select { |key, _value| %i[meeting_relay_result_id stroke_type_id swimmer_id badge_id].include?(key) }
    end
