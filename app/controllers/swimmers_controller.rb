...
class SwimmersController < ApplicationController
  ...
  def prepare_full_summary_stats_for(event_type, event_list)
...

    {
      ...
      count50:,
      count: count25 + count50,
      best_timing_mir: event_list.with_time.order(:minutes, :seconds, :hundredths).first,
      best_timing_mir25: event_list25.with_time.order(:minutes, :seconds, :hundredths).first,
      best_timing_mir50: event_list50.with_time.order(:minutes, :seconds, :hundredths).first,
      worst_timing_mir: event_list.with_time.order(:minutes, :seconds, :hundredths).last,
      worst_timing_mir25: event_list25.with_time.order(:minutes, :seconds, :hundredths).last,
      worst_timing_mir50: event_list50.with_time.order(:minutes, :seconds, :hundredths).last,
