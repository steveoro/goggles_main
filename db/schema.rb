...
ActiveRecord::Schema[8.1].define(version: 2026_08_17_170100) do
  ...
  create_table "api_daily_use_agents", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.index ["day", "user_agent"], name: "index_api_daily_use_agents_on_day_and_user_agent", unique: true
  end
  ...
  create_table "goggle_cups", id: :integer, charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    ...
    t.text "ranking_data", size: :long, collation: "utf8mb4_bin"
    ...
    t.index ["team_id", "season_year", "description"], name: "idx_goggle_cups_team_year_desc", unique: true
    t.index ["team_id"], name: "fk_goggle_cups_teams"
    t.check_constraint "json_valid(`ranking_data`)", name: "ranking_data"
  end
